...
public class BasePage {
	...
	public WebDriver initialize_driver(Properties prop) {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "/Users/yeyildiz/Downloads/chromedriver");
			...
			System.setProperty("webdriver.gecko.driver", "//users//yeyildiz//Downloads//geckodriver");
			if (headless.equalsIgnoreCase("yes")) {
